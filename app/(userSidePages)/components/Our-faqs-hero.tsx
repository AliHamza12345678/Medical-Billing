...
interface FaqsHeroBannerProps {
  title?: string;
  description?: string;
  currentPage?: string;
}

export default function FaqsHeroBanner({
  title = "Frequently Asked Questions",
  description = "Find clear answers to common inquiries regarding doctor consultations, online appointment scheduling, accepted health insurance plans, and general medical procedures.",
  currentPage = "FAQS",
}: FaqsHeroBannerProps) {
  return (
