...
export default function ContactHeroBanner({
  ...
  description = "Have questions about our medical services, appointments, or emergency care? Reach out to our dedicated clinical team for immediate assistance and compassionate support.",
