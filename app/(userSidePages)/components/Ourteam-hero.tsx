...
export default function TeamHeroBanner({
  ...
  description = "Our dedicated team of world-class physicians, surgeons, and healthcare specialists are committed to providing compassionate, industry-leading care for you and your family.",
