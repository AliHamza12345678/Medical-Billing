...
export default function ServicesHeroBanner({
  ...
  description = "Explore our wide range of medical specialties, diagnostic services, outpatient care, and advanced surgical procedures tailored to deliver exceptional patient outcomes.",
