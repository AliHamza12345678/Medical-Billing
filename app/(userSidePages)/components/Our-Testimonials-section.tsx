...
interface TestimonialsHeroBannerProps {
  title?: string;
  description?: string;
  currentPage?: string;
}

export default function TestimonialsHeroBanner({
  title = "Patient Stories & Reviews",
  description = "Read genuine experiences from patients who entrusted their health to our expert specialists, advanced clinical facilities, and personalized medical care.",
  currentPage = "TESTIMONIALS",
}: TestimonialsHeroBannerProps) {
  return (
