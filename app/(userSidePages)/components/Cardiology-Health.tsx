...
interface CardiologyHeroBannerProps {
  title?: string;
  description?: string;
  currentPage?: string;
}

export default function CardiologyHeroBanner({
  title = "Cardiology Health",
  description = "Comprehensive cardiovascular care including advanced heart diagnostics, preventive cardiology screenings, and specialized treatments led by world-class cardiologists.",
  currentPage = "SERVICES DETAILS",
}: CardiologyHeroBannerProps) {
  return (
